...
public class PyPlusPlusParser extends Parser {
	...
	public static final int
		...
		ARROW=46, IDENTIFIER=47, INTEGER=48, FLOAT=49, STRING=50, BOOL=51, WS=52, 
		COMMENT=53;
	public static final int
		...
		RULE_literal_list = 15, RULE_new_line = 16;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"literal", "type", "literal_list", "new_line"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IDENTIFIER", "INTEGER", "FLOAT", "STRING", "BOOL", "WS", "COMMENT"
		};
	}
	...
	public final Function_definitionContext function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4362896499433220L) != 0)) {
				{
				{
				setState(61);
				statement();
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4362896499277828L) != 0)) {
				{
				setState(86);
				expression(0);
				}
	...
	public static class New_lineContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PyPlusPlusListener ) ((PyPlusPlusListener)listener).enterNew_line(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PyPlusPlusListener ) ((PyPlusPlusListener)listener).exitNew_line(this);
		}
	}
	...
	public final New_lineContext new_line() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_new_line);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
